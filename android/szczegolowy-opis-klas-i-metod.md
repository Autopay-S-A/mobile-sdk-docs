...
Klasa reprezentująca błędy przychodzące z **SDK**, sama będąca błędem _Throwable_.
...
Zdarzenia przychodzące w callbacku _APWebView_.
...
_Dodatkowe parametry transakcji_
...
Klasa reprezentująca obecny stan widoku _APGatewayListCompose_/_APGatewayListView_.

* _APGatewaysLoading_ Definiuje stan ładowania listy kanałów płatności.
* _APGatewaysList_ Definiuje stan wyświetlania kanałów płatności.
* _APGatewayDetails_ Definiuje stan wyświetlania szczegółów grupy kanałów płatności. Grupa zdefiniowana jest parametrem _gatewayGroup_.
* _APPreTransactionInProgress_ Definiuje stan rozpoczęcia transakcji i oczekiwania na jej wykonanie w obrębie wskazanej grupy kanałów płatności parametrem _gatewayGroup_.
...
Widok rozwiniętej grupy kanałów płatności typu _BANK_. Nie zawiera podsumowania płatności.
...
Widok rozwiniętego kanału płatności typu _CARD_. Nie zawiera podsumowania płatności. Obsługuje zarówno płatność kartą, płatność kartą automatyczną oraz oba kanały.
...
Widok rozwiniętego kanału płatności typu _GOOGLE\_PAY_. Nie zawiera podsumowania płatności.
