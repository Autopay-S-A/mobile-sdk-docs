<!-- Generated by scripts/sync_magento_readme.py.
Source: https://github.com/bluepayment-plugin/magento-2.x-plugin/blob/master/README.md
...
### [Co nowego w Autopay?](https://github.com/bluepayment-plugin/magento-2.x-plugin/blob/master/CHANGELOG.md)
...
3. Przejdź do **Component Manager**, znajdź na liście moduł **BlueMedia/BluePayment**, kliknij **Select** i następnie **Enable**.
   ...
   ![install1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/install1.png "Screenshot")
...
5. Jeżeli chcesz, możesz w tym momencie utworzyć kopię zapasową kodu, mediów i bazy danych, klikając **Create Backup**. Następnie kliknij **Next**
   ...
   ![install2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/install2.png "Screenshot")
...
7. Aktywacja może potrwać kilka minut. Gdy zakończy się sukcesem, zobaczysz następujący komunikat:
   ![install3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/install3.png "Screenshot")
...
3. Uzupełnij dane dotyczące obsługiwanych walut (otrzymasz je od Autopay)
   ...
   2. **Klucz konfiguracyjny (hash) (Configuration key (hash))** - otrzymasz go od Autopay, możesz go odczytać także w portalu Autopay [Środowisko testowe](https://testportal.autopay.eu/admin), [Środowisko produkcyjne](https://portal.autopay.eu/admin) w szczegółach serwisu, jako **Klucz konfiguracyjny (hash)**
      ![configuration3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/configuration3.png "Screenshot")
...
![configuration1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/configuration1.png "Screenshot")
...
4. Kliknij **Wyślij (Submit)**
   ...
   ![configuration2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/configuration2.png "Screenshot")
...
![blik1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/blik1.png)
...
![gpay.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/gpay.png)
...
![automatic1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/automatic1.png)
...
3. Wybrać **Zapisane karty płatnicze (Saved payment cards)** z menu po lewej stronie. Wówczas wyświetli się lista zapisanych kart:
   ![automatic2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/automatic2.png)
...
![admin1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/admin1.png)

Link do płatności zostanie przesłany przez Autopay na adres mailowy widoczny w danych klienta.

![admin2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/admin2.png)
...
3. Jeżeli zamówienie zostało opłacone z wykorzystaniem metody płatności Autopay, w górnym menu powinien być widoczny przycisk Zwrot Autopay.
   ...
   ![refund1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/refund1.png)
...
6. Informacje dot. zwrotu są widoczne:
   1. w komentarzach do zamówienia
      ...
      ![refund2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/refund2.png)
   2. na liście transakcji
   
      ![refund3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/refund3.png)
...
![refund4.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/refund4.png)

![refund5.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/refund5.png)
...
4. Kliknij **Strumienie danych (Streams)**.  
   ![ga1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/ga1.png "Screenshot")
5. Kliknij odpowiedni stream, który jest przypisany do Twojego sklepu. 
   ![ga2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/ga2.png "Screenshot")
...
6. Wybierz **Tajne klucze API platformy Measurement Protocol (Measurement Protocol)** (w tabeli **Ustawienia dodatkowe**).
   ![ga3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/ga3.png "Screenshot")
7. Kliknij **Utwórz (Create)**.

### Konfiguracja Google Analytics
1. Wybierz z menu **Sklepy (Stores)** -> **Konfiguracja (Configuration)** -> **Sprzedaż (Sales)** -> **Google API**.    
   ![analytics1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/analytics1.png "Screenshot")
...
4. Wprowadź **API Secret** wygenerowany zgodnie z instrukcją powyżej.  
   ![analytics2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/analytics2.png "Screenshot")
...
2. W zakładce **Promowanie płatności (Promoting payments)** określ, w których miejscach promowane płatności mają być wyświetlane.
   ![cf1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf1.png "Screenshot")

### Przykładowa wizualizacja
**Na górze strony (At the top of the page)**  
![cf2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf2.png "Screenshot")

**Pod nawigacją (Under the navigation)**  
![cf3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf3.png "Screenshot")

**Na liście produktów (On the product list)**   
![cf4.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf4.png "Screenshot")

**Na stronie produktu pod przyciskami (On the product page under the buttons)**  
![cf5.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf5.png "Screenshot")

**W koszyku pod produktami (In the shopping cart under the products)**  
![cf6.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/cf6.png "Screenshot")
...
2. Przejdź do **Menadżera komponentów (Component Manager)** i znajdź na liście moduł **BlueMedia/BluePayment** i kliknij **Select**, a później **Disable**.
   ...
   ![dezactivation1.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/dezactivation1.png)
...
4. Jeżeli chcesz, możesz w tym momencie utworzyć kopię zapasową kodu, mediów i bazy danych, klikając **Create Backup**.
   ...
   ![dezactivation2.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/dezactivation2.png)
...
7. Dezaktywacja może potrwać kilka minut. Gdy zakończy się sukcesem, zobaczysz następujący komunikat:
   ![dezactivation3.png](https://raw.githubusercontent.com/bluepayment-plugin/magento-2.x-plugin/master/docs/dezactivation3.png)
