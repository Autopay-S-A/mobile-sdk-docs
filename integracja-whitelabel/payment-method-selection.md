...
Poniżej znajduje się podstawowy schemat pierwszej transakcji Autopay w tym modelu. Proces zaczyna się od pobrania aktualnej konfiguracji kanałów, następnie pobrania danych prawnych wymaganych dla wybranego kanału, zainicjowania płatności przez `payment`, a kończy się asynchronicznym odebraniem i potwierdzeniem komunikatu ITN.
