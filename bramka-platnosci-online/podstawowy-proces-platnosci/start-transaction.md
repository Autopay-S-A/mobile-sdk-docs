...
Wszystkie parametry przekazywane są metodą POST (_Content-Type: application/x-www-form-urlencoded_).
...
* [https://{host\_bramki}/sciezka](https://{host_bramki}/sciezka)
...
[Pełna tabela parametrów startowych](../dane-transakcji/parameters.md) · [Dodatkowe parametry](../dane-transakcji/additional-parameters.md) · [Hash](../bezpieczenstwo/hashing.md)
