...
_Hash = funkcja(wartości\_pola\_1\_komunikatu + "|" + wartości\_pola\_2\_komunikatu + "|" + ... + "|" + wartości\_pola\_n\_komunikatu + "|" + klucz\_współdzielony);_
...
> ServiceID = 2
>
> klucz\_współdzielony = 2test2
>
> Adres bramki [https://{host\_bramki}/sciezka](https://{host_bramki}/sciezka)
...
**WSKAZÓWKA:** Opcja szczegółowo omówiona w części [Koszyk produktów](../dane-transakcji/product-basket.md#koszyk-produktów).
